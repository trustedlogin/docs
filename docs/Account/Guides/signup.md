...
<!-- Auto-generated by the 'signup' doc-flow spec. Edits to this file will be overwritten on the next run — update the spec to change the doc. -->
...
Double-check your email address before clicking **Create account** — it's harder to change later than to get right the first time. Click Create account when you're ready.
