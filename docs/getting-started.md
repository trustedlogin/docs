...
:::info
A new Vendor plugin should be ready by mid-March with a brand-new UI and onboarding flow!
:::
...
1. [Download the Vendor plugin](https://github.com/trustedlogin/trustedlogin-vendor/archive/refs/heads/develop.zip)
