...
1. Get the plugin from the [WordPress.org plugin page](https://wordpress.org/plugins/trustedlogin-connector/) — or [download the latest ZIP directly](https://downloads.wordpress.org/plugin/trustedlogin-connector.zip)
